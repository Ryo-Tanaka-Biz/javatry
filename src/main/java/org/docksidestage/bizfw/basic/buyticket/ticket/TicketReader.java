...
public class TicketReader {
    ...
    public void doInPark(PresentTimeManager presentTimeManager) {
        ...
        // (単なる行数切り出しではない)
        // done tanaryo 名前が逆？canEnterPark()じゃなくてcannotEnterPark()とか by jflute (2024/10/03)
        // done tanaryo メソッド名にtimeのニュアンスが欲しいかも、例外メッセージがtimeのこと言ってるので by jflute (2024/10/03)
    ...
    // done tanaryo たぶん、IntelliJのショートカットでメソッド抽出すると、(付けられるときは)static付くのかも？ by jflute (2024/10/03)
